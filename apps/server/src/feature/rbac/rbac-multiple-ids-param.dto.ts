...
import { MultipleRbacIdsShouldExist } from '../../core/validator/multiple-rbac-ids-should-exist.validator';

export class RbacMultipleIdsParamDto {
  @Validate(MultipleRbacIdsShouldExist)
